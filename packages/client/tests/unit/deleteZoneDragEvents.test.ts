...
import type { DraggableItem, ExistingDraggableItem, IDragState } from '../../src/private/dnd/types.js'
...
interface DeleteZoneOptions {
	dragStateStore: ReturnType<typeof writable<IDragState<DraggableItem, ExistingDraggableItem<DraggableItem>>>>
	setIsHovered: (hovered: boolean) => void
}

describe('deleteZoneDragEvents', () => {
	let node: HTMLElement
	let dragStateStore: ReturnType<typeof writable<IDragState<DraggableItem, ExistingDraggableItem<DraggableItem>>>>
	let setIsHovered: ReturnType<typeof vi.fn>
	let action: ActionReturn<DeleteZoneOptions> | undefined

	beforeEach(() => {
		node = document.createElement('div')
		dragStateStore = writable<IDragState<DraggableItem, ExistingDraggableItem<DraggableItem>>>({
