...
// @ts-expect-error
const badScalarComparator2: ScalarComparator<Foo> = { isEqual: (a, b) => true, isLessThan: (a, b) => true };
// @ts-expect-error
const badScalarComparator3: ScalarComparator<Foo> = { isEqual: (a, b) => true, isLessThan: (a, b) => true, isGreaterThan: (a, b) => 123 }; 